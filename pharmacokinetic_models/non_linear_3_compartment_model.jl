...
# ╔═╡ ab4ef100-9b7b-11f1-8b08-25960d8fc334
begin
	using DifferentialEquations
	using Plots
end

# ╔═╡ 19f33af9-ef3b-44d0-92ac-0cc1366633b7
function non_linear_multicompartment_model!(dC,M,p,t)
	M_1, M_2, M_3 = M # Masses
	k12, k13, k21, k31, v_max, K_m, V_1, V_2, V_3 = p
	# Convert masses to concentrations
	C_1 = M_1/V_1
	C_2 = M_2/V_2
	C_3 = M_3/V_3
	numerator = (v_max*C_1)
	denominator = (K_m+C_1)
	elim = numerator/denominator # Michaelis-Menten elimination
	dC[1] = -(k12+k13)*C_1 - elim  + k21*C_2*(V_2/V_1) + k31*C_3*(V_3/V_1) # Central Compartment i.e. Compartment 1
	dC[2] = k12*C_1*(V_1/V_2) - k21*C_2 # Shallow Tissue i.e. Compartment 2
	dC[3] = k13*C_1*(V_1/V_3) - k31*C_3 # Deep Tissue i.e. Compartment 3
end

# ╔═╡ 5efcf966-875b-468a-b3b3-f6ea3744966f
u0 = [100, 0, 0] # Central Compartment, Shallow Tissue, Deep Tissue

# ╔═╡ 2d1a771c-20dc-4a20-8517-417d95fefaed
tspan = (0,24) # 24 Hour period

# ╔═╡ 3d0536b1-e7fe-4d90-9a00-a9584daea280
p = (
    k12 = 0.60,   # Blood to shallow tissue clearance fraction
    k13 = 0.15,   # Blood to deep tissue clearance fraction
    k21 = 0.30,   # Shallow tissue back-distribution fraction
    k31 = 0.02,   # Deep tissue sluggish washout fraction
    v_max = 15.0, # Maximum metabolic elimination velocity (mg/hr)
    K_m = 5.0,    # Michaelis constant (mg/L)
    V_1 = 5.0,    # Central Blood Volume (L)
    V_2 = 10.0,   # Shallow Tissue Volume (L)
    V_3 = 25.0    # Deep Tissue/Fat Volume (L)
)


# ╔═╡ 1fe22aa1-cd7e-4036-b1cb-9a34cc5713ff
prob = ODEProblem(non_linear_multicompartment_model!, u0, tspan, p)

# ╔═╡ 4abd4a1a-147f-4342-82f1-b24200bba8d3
sol = solve(prob, Tsit5(), saveat = 1) # Non-linear ODEs so need to solve with Tsit5(), Concentrations calculated in 1 hour intervals

# ╔═╡ 8ee17a5c-074b-462e-8202-7078b381dab7
plot(sol,
	idxs = [1,2,3],
	labels = ["Central Compartment (C1)" "Shallow Tissue (C2)" "Deep Tissue(C3)"],
	xlabel = "Time (h)",
	ylabel = "Concentration (mg/L)",
	title = "Non-linear 3 Compartment Pharmacokinetic Model",
	lw = 2)
...
manifest_format = "2.0"
project_hash = "46745cf67b559c449e7ac867865cbadb7a91980d"
