...
# ╔═╡ bdfd9c4c-9b77-11f1-b75e-41ba28f85d91
begin
...
# ╔═╡ c6dbded1-d515-40c1-89d5-727b883cb614
function linear_multicompartment_model(compartment,p,t)
	k12, k21, k13, k31, ke = p
	system = [-(ke+k12+k13) k21 k31; # Central Compartment
			 	 k12 -k21 0; # Tissue 1
			 	 k13 0 -k31] # Tissue 2
	return system * compartment
end

# ╔═╡ f1229280-ef99-4bc3-8a8f-ec2aa17f86f7
...
# ╔═╡ 6efca967-7e10-4c72-8d12-59535e988de5
prob = ODEProblem(linear_multicompartment_model, u0, tspan,p)

# ╔═╡ 3bc43f07-9d58-4b99-88ad-386ea2258399
sol = solve(prob)
...
manifest_format = "2.0"
project_hash = "41f5942f3a74601e9984b59daaeac8614766c954"
