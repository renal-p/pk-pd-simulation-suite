...
# ╔═╡ 3e41fa7a-9b9a-11f1-a3d6-bb5d19221312
begin
...
# ╔═╡ 87d873e5-bef6-47b3-99c5-f9d8eeb0980b
Huang_Ferrell_MAPK_model = @reaction_network begin
	(a1, d1), Mapkkk + E1 <--> MapkkkE1
	k1, MapkkkE1 --> MapkkkAct + E1
	(a2, d2), MapkkkAct + E2 <--> MapkkkActE2
	k2, MapkkkActE2 --> Mapkkk + E2
	(a3, d3), Mapkk + MapkkkAct <--> MapkkMapkkkAct
	k3, MapkkMapkkkAct --> MapkkP + MapkkkAct
	(a4, d4), MapkkP + Mapkkpase <--> MapkkPMapkkpase
	k4, MapkkPMapkkpase --> Mapkk + Mapkkpase
	(a5, d5), MapkkP + MapkkkAct <--> MapkkPMapkkkAct
	k5, MapkkPMapkkkAct --> MapkkPP + MapkkkAct
	(a6, d6), MapkkPP + Mapkkpase <--> MapkkPPMapkkpase
	k6, MapkkPPMapkkpase --> MapkkP + Mapkkpase
	(a7, d7), MapkkPP + Mapk <--> MapkkPPMapk
	k7, MapkkPPMapk --> MapkkPP + MapkP
	(a8, d8), MapkP + Mapkpase <--> MapkPMapkpase
	k8, MapkPMapkpase --> Mapk + Mapkpase
	(a9, d9), MapkP + MapkkPP <--> MapkPMapkkPP
	k9, MapkPMapkkPP --> MapkPP + MapkkPP
...
# ╔═╡ 730b10db-36ae-469f-9e4e-a7496af19619
ps = [
	:a1 => 1000.0,  :d1 => 150.0,  :k1 => 150.0,
	:a2 => 1000.0,  :d2 => 150.0,  :k2 => 150.0,
	:a3 => 1000.0,  :d3 => 150.0,  :k3 => 150.0,
	:a4 => 1000.0,  :d4 => 150.0,  :k4 => 150.0,
	:a5 => 1000.0,  :d5 => 150.0,  :k5 => 150.0,
	:a6 => 1000.0,  :d6 => 150.0,  :k6 => 150.0,
	:a7 => 1000.0,  :d7 => 150.0,  :k7 => 150.0,
	:a8 => 1000.0,  :d8 => 150.0,  :k8 => 150.0,
	:a9 => 1000.0,  :d9 => 150.0,  :k9 => 150.0,
	:a10 => 1000.0, :d10 => 150.0, :k10 => 150.0
]
# Parameters taken from Biomodels BIOMD0000000009

# ╔═╡ 2e31ceef-f832-404a-8049-0e5ece933ea9
@bind log_E1 Slider(-8:0.1:-3, default = -5,show_value=true)

# ╔═╡ 040fc99e-7020-430c-8b38-2879f4ac7a2d
E1_conc = 10^log_E1
...
u0 = [
	...
	:E2           => 0.0003,      # 0.3 nM -> 0.0003 uM
	:Mapkkpase    => 0.0003,      # 0.3 nM -> 0.0003 uM
	:Mapkpase     => 0.12,        # 120 nM -> 0.12 uM
	
	# Complexes and active forms all start at 0.0
	:MapkkkE1     => 0.0,
	:MapkkkAct    => 0.0,
	:MapkkkActE2  => 0.0,
	:MapkkMapkkkAct => 0.0,
...
# ╔═╡ 01c584c1-a23c-49ad-84b6-c546e560dbbb
sol = solve(prob, Tsit5(), abstol = 1e-8, reltol = 1e-8)

# ╔═╡ 3106b2d3-e4ab-4a08-8934-9efddcd5e4ad
plot(sol, 
	 idxs = [:MapkPP],
  label = ["MAPK-PP"],
  xlabel = "Time (s)",
  ylabel = "Concentration (um)",
  title = "Huang-Ferrel Ultrasensitive Switch MAPK Model",
  lw = 3
  )
...
manifest_format = "2.0"
project_hash = "53fa9afb17e62329e9878af2533d7453e2b5a62e"
...
git-tree-sha1 = "893d7ec9a77f17f3ec2f35ba019bb3fe816e8b12"
...
git-tree-sha1 = "12b1273a18b67f7ff6d4e19ab038c29b5b43a07d"
...
git-tree-sha1 = "79f5f1c65b7147e0fe0d3c6a65e09a7fddd2a010"
...
git-tree-sha1 = "dbec384f239f923c1566c1bfa0a53b49ab4b5b03"
